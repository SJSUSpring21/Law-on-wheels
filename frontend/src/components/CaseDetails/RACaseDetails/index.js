            ...
            <div class="w3-twothird">
              <div class="w3-container w3-card w3-white w3-margin-bottom w3-margin-top">
                ...
                <div class="w3-container">
                  ...
                  <h6 class="w3-text-teal">
                    {this.state.caseDetails
                      ? this.state.caseDetails.tenants[0].name
                      : "loading"}
                  </h6>
                ...
                <div class="w3-container">
                  ...
                  <h6 class="w3-text-teal">
                    {this.state.caseDetails
                      ? this.state.caseDetails.tenants[0].parentName
                      : "loading"}
                  </h6>
                ...
                <div class="w3-container">
                  ...
                  <h6 class="w3-text-teal">
                    {this.state.caseDetails
                      ? this.state.caseDetails.tenants[0].email
                      : "loading"}
                  </h6>
                ...
                <div class="w3-container">
                  ...
                  <h6 class="w3-text-teal">
                    {this.state.caseDetails
                      ? this.state.caseDetails.tenants[0].address
                      : "loading"}
                  </h6>
              ...
              <div class="w3-container w3-card w3-white w3-margin-bottom">
                ...
                <div class="w3-container">
                  ...
                  <h6 class="w3-text-teal">
                    {this.state.caseDetails
                      ? this.state.caseDetails.propertyNumber
                      : "loading"}
                  </h6>
                  <p></p>
                  <hr />
                ...
                <div class="w3-container">
                  ...
                  <h6 class="w3-text-teal">
                    {this.state.caseDetails
                      ? this.state.caseDetails.propertyState
                      : "loading"}
                  </h6>
                  <hr />
                </div>
                ...
                <div class="w3-container">
                  ...
                  <h6 class="w3-text-teal">
                    {this.state.caseDetails
                      ? this.state.caseDetails.propertyCity
                      : "loading"}
                  </h6>
                  <hr />
                </div>
                <div class="w3-container">
                  ...
                  <h6 class="w3-text-teal">
                    {this.state.caseDetails
                      ? this.state.caseDetails.propertyAddress
                      : "loading"}
                  </h6>
                  <hr />
                </div>
                <div class="w3-container">
                  ...
                  <h6 class="w3-text-teal">
                    {this.state.caseDetails
                      ? this.state.caseDetails.propertyLocality
                      : "loading"}
                  </h6>
                  <hr />
                </div>
                <div class="w3-container">
                  ...
                  <h6 class="w3-text-teal">
                    {this.state.caseDetails
                      ? this.state.caseDetails.propertyZipCode
                      : "loading"}
                  </h6>
                  <hr />
                </div>
                <div class="w3-container">
                  ...
                  <h6 class="w3-text-teal">
                    {this.state.caseDetails
                      ? this.state.caseDetails.propertyFloor
                      : "loading"}
                  </h6>
                  <br />
                </div>
              ...
              <div class="w3-container w3-card w3-white w3-margin-bottom">
                ...
                <div class="w3-container">
                  ...
                  <h6 class="w3-text-teal">
                    {this.state.caseDetails
                      ? this.state.caseDetails.agreementStartDate.split("T")[0]
                      : "loading"}
                  </h6>
                ...
                <div class="w3-container">
                  ...
                  <h6 class="w3-text-teal">
                    {this.state.caseDetails
                      ? this.state.caseDetails.noticePeriod
                      : "loading"}
                  </h6>
                ...
                <div class="w3-container">
                  ...
                  <h6 class="w3-text-teal">
                    {this.state.caseDetails
                      ? this.state.caseDetails.rentPaymentDate
                      : "loading"}
                  </h6>
                ...
                <div class="w3-container">
                  ...
                  <h6 class="w3-text-teal">
                    {this.state.caseDetails
                      ? this.state.caseDetails.securityAmount
                      : "loading"}
                  </h6>
