...
export class MDCaseDetails extends Component {
    ...
    changeStatus = async (status) => {
        ...
        if (newNextStatus) {
            ...
            axios
                .get(
                    `${Server}/cases/status/next/${case_id}?type=${case_type}`,
                    {
                        headers: {
                            Authorization:
                        ...
                        <div class="w3-twothird">
                            <div class="w3-container w3-card w3-white w3-margin-bottom w3-margin-top">
                                ...
                                <div class="w3-container">
                                    ...
                                    <h6 class="w3-text-teal">
                                        {this.state.caseDetails
                                            ? this.state.caseDetails.marriageDate.split(
                                                  "T"
                                              )[0]
                                            : "loading"}
                                    </h6>
                            ...
                            <div class="w3-container w3-card w3-white w3-margin-bottom">
                                ...
                                <div class="w3-container">
                                    ...
                                    <h6 class="w3-text-teal">
                                        {this.state.caseDetails
                                            ? this.state.caseDetails.husbandBirthday.split(
                                                  "T"
                                              )[0]
                                            : "loading"}
                                    </h6>
                            ...
                            <div class="w3-container w3-card w3-white w3-margin-bottom">
                                ...
                                <div class="w3-container">
                                    ...
                                    <h6 class="w3-text-teal">
                                        {this.state.caseDetails
                                            ? this.state.caseDetails.wifeBirthday.split(
                                                  "T"
                                              )[0]
                                            : "loading"}
                                    </h6>
                                ...
                                <div class="w3-container">
                                    <h5 class="w3-opacity">
                                        <b>
                                            ...
                                            Maintenance/Alimony and Joint Assets
                                        </b>
                                    </h5>
                                    <h6 class="w3-text-teal">
                                        {this.state.caseDetails &&
