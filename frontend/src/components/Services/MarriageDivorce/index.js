            ...
            <div class="row md-header">
              <div class="col-lg-12 col-md-12">
                <div class="section-title text-center">
                  ...
                  <p class="md-p">
                    If both Husband & Wife want divorce and have decided the
                    terms of separation, then just fill-in these details below.
                  </p>
                </div>
              </div>
            </div>
              ...
              <div class="row align-items-center justify-content-center">
                <div class="col-md-8 col-md-offset-2">
                  <div id="register-form" class="register-form">
                    ...
                    <div class="section-field border-extra ">
                      ...
                      <div class="row">
                        <div class="section-field col-md-6">
                          <label>Name of Banquet Hall *</label>
                          <div class="field-widget">
                            <input
                              name="pomBanquet"
                              type="text"
                    ...
                    <div class="section-field border-extra ">
                      <h5>Need the name of Husband and Wife</h5>
                      <div class="row">
                        <div class="section-field col-md-6">
                    ...
                    <div class="section-field border-extra ">
                      <h5>
                        Please enter the Father’s name of the Husband & Wife
                      </h5>
                      <div class="row">
                        <div class="section-field col-md-6">
                          <label>Husband *</label>
                    ...
                    <div class="section-field border-extra ">
                      <h5>Date of Birth is required for both the parties</h5>
                      <div class="row">
                        <div class="section-field col-md-6">
                          <label>Husband *</label>
                          <div class="field-widget">
                    ...
                    <div class="section-field border-extra ">
                      <h5>Please share your contact numbers</h5>
                      <div class="row">
                        <div class="section-field col-md-6">
                          <label>Husband *</label>
                          <div class="field-widget">
                    ...
                    <div class="section-field border-extra ">
                      <h5>Please share your email address</h5>
                      <div class="row">
                        <div class="section-field col-md-6">
                          <label>Husband *</label>
                          <div class="field-widget">
                    ...
                    <div class="section-field border-extra ">
                      <h5>
                        Please provide us your residence address before marriage
                      </h5>
                      <div class="row">
                        <div class="section-field col-md-6">
                          <label>Husband *</label>
                    ...
                    <div class="section-field border-extra ">
                      <h5>
                        Post-marriage address (where parties resided together
                        after marriage) *{" "}
                      </h5>
                      <div class="field-widget">
                        <input
                    ...
                    <div class="section-field border-extra ">
                      <h5>Please share your present address</h5>
                      <div class="row">
                        <div class="section-field col-md-6">
                          <label>Husband *</label>
                          <div class="field-widget">
                    ...
                    <div class="section-field border-extra ">
                      <h5>Need settlement regarding Maintenance/Alimony </h5>
                      <div class="box">
                        <select
                    ...
                    <div class="section-field border-extra ">
                      <h5>Need settlement regarding joint assets </h5>
                      <div class="box">
                        <select
                          name="settleAssets"
                          id="settleAssets"
